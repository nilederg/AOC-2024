...
public class Vector2 {
    ...
    public static final Collection<Vector2> VON_NEUMANN_NEIGHBORHOOD = List.of(new Vector2[]{
            new Vector2(1, 0),
            new Vector2(-1, 0),
            new Vector2(0, 1),
            new Vector2(0, -1),
    });
    public static final Collection<Vector2> MOORE_NEIGHBORHOOD = List.of(new Vector2[]{
            new Vector2(-1, -1),
            new Vector2(0, -1),
            new Vector2(1, -1),
            new Vector2(-1, 0),
    ...
    public Vector2 multiply(long scalar) {
